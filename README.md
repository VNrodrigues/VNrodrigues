...
- 🔭 Atualmente não estou trabalhando, estou em busca de uma oportunidade de emprego!
- 🖥️ Hoje em dia estou cursando análise e desenvolvimento de sistemas na Uninter.
- 📚 Tenho conhecimentos em Python, análise / tratamento / extração de dados, HTML5, CSS3, Bootstrap, mySQL, SQL Server e Git.
